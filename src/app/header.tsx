    ...
    <nav className="bg-darkmode-500 w-full z-20 top-0 start-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button type="button" className="text-white bg-black hover:bg-black/90 focus:ring-4 hover:blur-[3px] transition focus:outline-none focus:ring-black/80 font-medium rounded-lg text-sm px-4 py-2 text-center">Get started</button>
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  bg-darkmode-400 md:bg-darkmode-500 dark:border-gray-700">
            ...
            <li>
              <a href="/prices" className="block py-2 px-3 text-gray-900 hover:underline rounded hover:bg-gray-100 md:hover:bg-transparent  md:p-0  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Prices</a>
            </li>
            <li>
