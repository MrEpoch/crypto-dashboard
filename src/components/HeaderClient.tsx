...
export default function HeaderClient() {
  ...
  return (
    ...
    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <Link href="/cryptoPrices" className="text-white bg-black sm:block hidden hover:bg-black/90 focus:ring-4 hover:blur-[3px] transition focus:outline-none focus:ring-black/80 font-medium rounded-lg text-sm px-4 py-2 text-center">Get started</Link>
